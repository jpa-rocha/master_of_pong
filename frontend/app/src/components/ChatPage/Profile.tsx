...
const ProfilePageChat: React.FunctionComponent<ProfilePageProps> = ({
  socket, profileID, profileToggle, setProfileToggle}) => {
  ...
  return (
	...
	{isOpen && (
		...
		<button className="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 
					rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center"
					onClick={closeProfile}
			>
			x
		</button>
			<div className="flex flex-col items-center justify-around flex-wrap md:flex-row bg-yellow-50 border border-gray-200 rounded-lg shadow
          ...
          <h2 className="text-center font-bold my-5 md:mt-0"> Match History</h2>
