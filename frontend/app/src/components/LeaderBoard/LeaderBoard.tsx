                ...
                {leaders.map((leader, index) => (
                  <tr className="rounded-lg shadow-lg bg-gradient-to-r from-orange-300 via-yellow-400 to-orange-300" key={index}>
                    <th scope="row"  className="text-sm md:text-lg px-6 py-3 font-medium text-gray-900" >
                      ...
                      <td className="px-6 py-3 text-sm md:text-lg 2xl:text-2xl">{leader.wins}</td>
                      <td className="px-6 py-3 text-sm md:text-lg 2xl:text-2xl">{leader.losses}</td>
                      ...
                      <td className="px-6 py-3 text-sm md:text-lg 2xl:text-2xl">{leader.elo}</td>
                      <td className="px-6 py-3 text-sm md:text-lg 2xl:text-2xl">{leader.rank}</td>
                  </tr>
                ))}
              </tbody>
            </table>
