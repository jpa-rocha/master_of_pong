...
export class ImageContainer {
  ...
  constructor() {
    ...
    this.ImageLoader = this.importAll(
      require.context(
        "../../images/loadscreen/rotate",
        false,
        /\.(png|jpe?g|svg)$/
      )
    );
    this.ImageLoader.forEach((image: any) => {
      ...
      this.YinYangRotate[this.YinYangRotate.length - 1].onload =
        this.incrementCounter;
      this.YinYangRotate[this.YinYangRotate.length - 1].src = image;
    });
    this.ImageLoader = this.importAll(
      require.context(
        "../../images/loadscreen/end",
        false,
        /\.(png|jpe?g|svg)$/
      )
    );
    this.ImageLoader.forEach((image: any) => {
      ...
      this.YinYangEnd[this.YinYangEnd.length - 1].onload =
        this.incrementCounter;
      this.YinYangEnd[this.YinYangEnd.length - 1].src = image;
    });
    this.ImageLoader = this.importAll(
      require.context("../../images/cd", false, /\.(png|jpe?g|svg)$/)
    );
    this.ImageLoader.forEach((image: any) => {
      this.totalImages++;
